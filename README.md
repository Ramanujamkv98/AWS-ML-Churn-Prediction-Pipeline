...
Architecture & Tools I Used# AWS Churn Prediction Pipeline + Retention Decisioning

GitHub notebook preview may occasionally fail.

View the fully rendered Phase 1 notebook here:  
https://nbviewer.org/github/Ramanujamkv98/AWS-ML-Churn-Prediction-Pipeline/blob/main/01_churn_pipeline_setup.ipynb

View the fully rendered Phase 2 notebook here:  
ADD_PHASE_2_NBVIEWER_LINK_HERE
